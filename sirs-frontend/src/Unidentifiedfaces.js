...
function Unidentifiedfaces() {
    ...
    const [seen_r, SetSeen] = useState(0)
    const [seen_name, SetSeenName] = useState("Unseen")

    const [m_style, setMstyle] = useState({})
    ...
    // const style2 = {
    //     'div1': { 'min-height': '450px', 'max-height': '350px', 'width': '200px' },
    //     'img': { 'width': '150px', 'border-radius': '30px' },
    //     'p': { 'font-size': '13px' },
    //     'btn_style': { },
    //     'btn_text': "Get Details",
    // }
    ...
    // The commneted function is used to filter the data based on seen
    // console.log(ids)
    // const filtered = ids.filter(function (i){
    //     return i.seen ==seen_r
    // })

    // console.log(filtered)

    // const listItems = ids.map(person =>
    //     <div className='container border m-2  p-2 id_cards' style={{ 'min-height': '350px', 'max-height': '350px', width: '200px' }}  >
    ...
    return (
        <div className='container-fluid m-0 p-0' >
            <div className='container-fluid w-100 ' style={{ 'background-color': '#060041', 'min-height': '8vh' }} >
                <Top_bar page={seen_name + " Identified Faces"} />
            </div>
            <div style={{ 'display': 'flex', 'height': '91vh', 'background-color': '#fff' }}>
                ...
                <div className='container w-50 p-3 ' style={{ 'max-height': "800px" }}>
                    ...
                    <div className='' style={{ display: 'flex' }}>
                        ...
                        <div className='mx-2' style={{ 'backgroundColor': 'lavender', borderRadius: '20px' }}>
                    ...
                    <div className='container p-0 ' style={{ display: 'flex', 'flex-wrap': 'wrap', overflow: 'scroll', 'max-height': '75vh' }}>
